...
class TestCRS:
    ...
    def test_epsg(self):
        ...
        assert_almost_equal(uk.x_limits, (-104728.764, 688806.007), decimal=3)
        assert_almost_equal(uk.y_limits, (-8908.36, 1256616.32), decimal=2)
        assert_almost_equal(uk.threshold, 7935.34, decimal=2)
        self._check_osgb(uk)
